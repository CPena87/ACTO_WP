				...
				<div class="form-field">
					...
					<fieldset>
						...
						<div class="zone_type_options zone_type_postcodes">
					        ...
					        <label for="postcodes"><?php _e( 'Postcodes', 'wc_table_rate' ); ?> <img class="help_tip" width="16" data-tip='<?php _e('List 1 postcode per line. Wildcards (*) and ranges (for numeric postcodes) are supported.', 'wc_table_rate') ?>' src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></label>
